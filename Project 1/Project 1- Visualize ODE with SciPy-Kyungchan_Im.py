...
# Jan 22, 2023
# Packages required: numpy, scipy, matplotlib
# This file require the installation for packages above.
# If those packages are not installed, if you are using
# any ide for python, then install packages by using
